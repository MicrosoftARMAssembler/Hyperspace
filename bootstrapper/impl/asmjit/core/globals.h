...
enum ErrorCode : uint32_t {
  ...
  //! Could not allocate consecutive registers - allocable registers either too restricted or a bug in RW info.
  ...
  //! Could not open anonymous memory handle or file descriptor.
